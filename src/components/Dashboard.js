    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          ...
          React.createElement('p', {
            style: { color: '#e2e8f0', fontSize: '1.125rem' }
          }, 'Track and manage all your tax filings')
        ),
        
        taxReturns.length === 0 ? React.createElement('div', {
          style: {
            textAlign: 'center',
            padding: '3rem',
            color: '#9ca3af'
          ...
          React.createElement('p', { style: { fontSize: '1.25rem' } }, 'No tax returns created yet'),
          React.createElement('p', { style: { fontSize: '1rem' } }, 'Connect your backend to start creating tax returns')
        ) : React.createElement('div', {
          style: {
            display: 'grid',
        ...
        }, taxReturns.map(function(taxReturn, index) {
          return React.createElement('div', {
            key: index,
            style: {
            ...
            React.createElement('p', {
              style: { color: '#9ca3af', fontSize: '1rem', marginBottom: '1rem' }
